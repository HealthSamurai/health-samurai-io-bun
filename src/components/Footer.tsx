      ...
      <footer className="bg-gray-900">
        <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li><a href="/company" className="text-sm leading-6 text-gray-400 hover:text-white">About Us</a></li>
                    <li><a href="/careers" className="text-sm leading-6 text-gray-400 hover:text-white">Careers</a></li>
                    <li><a href="/news" className="text-sm leading-6 text-gray-400 hover:text-white">News</a></li>
                    <li><a href="/blog" className="text-sm leading-6 text-gray-400 hover:text-white">Blog</a></li>
                    <li><a href="/contacts" className="text-sm leading-6 text-gray-400 hover:text-white">Contact Us</a></li>
                  </ul>
                </div>
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm leading-6 font-semibold text-white">Products</h3>
                  <ul role="list" className="mt-6 space-y-4">
                    <li><a href="/fhir-server" className="text-sm leading-6 text-gray-400 hover:text-white">Aidbox FHIR Server</a></li>
                    <li><a href="/fhir-database" className="text-sm leading-6 text-gray-400 hover:text-white">Fhirbase</a></li>
                    <li><a href="/medical-form" className="text-sm leading-6 text-gray-400 hover:text-white">Aidbox Forms</a></li>
                    <li><a href="/fhir-api" className="text-sm leading-6 text-gray-400 hover:text-white">FHIR API</a></li>
                  </ul>
                </div>
              </div>
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li><a href="/casestudies" className="text-sm leading-6 text-gray-400 hover:text-white">Case Studies</a></li>
                    <li><a href="/services" className="text-sm leading-6 text-gray-400 hover:text-white">Services</a></li>
                    <li><a href="/opensource" className="text-sm leading-6 text-gray-400 hover:text-white">Open Source</a></li>
                    <li><a href="https://docs.aidbox.app" target="_blank" className="text-sm leading-6 text-gray-400 hover:text-white">Documentation</a></li>
                  </ul>
                </div>
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm leading-6 font-semibold text-white">Legal</h3>
                  <ul role="list" className="mt-6 space-y-4">
                    <li><a href="/legal/privacy-policy" className="text-sm leading-6 text-gray-400 hover:text-white">Privacy Policy</a></li>
                    <li><a href="/legal/cookie-policy" className="text-sm leading-6 text-gray-400 hover:text-white">Cookie Policy</a></li>
                  </ul>
                  <div className="mt-8">
                    <h3 className="text-sm leading-6 font-semibold text-white">Contact</h3>
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm leading-6 text-gray-400">&copy; 2024 Health Samurai, Inc. All rights reserved.</p>
            {gitInfo.branch && (
