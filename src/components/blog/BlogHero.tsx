		...
		<section class="py-24 sm:py-32 px-6 lg:px-8">
			<div class="max-w-[1200px] mx-auto">
				...
				<div class="flex flex-col items-center max-w-3xl mx-auto mb-24 text-center">
					...
					<p class="mt-4 text-lg text-gray-600 w-full">
						Our experts have a deep understanding of FHIR, and here you will
						find the most relevant articles
					</p>
				</div>

				{/* Search Box with Tags - Figma node: 616:5522 */}
				<div class="bg-white border border-neutral-200 rounded-3xl p-[32px] max-w-[932px] mx-auto shadow-[0px_200px_56px_0px_rgba(56,68,77,0),0px_128px_51px_0px_rgba(56,68,77,0),0px_72px_43px_0px_rgba(56,68,77,0.01),0px_32px_32px_0px_rgba(56,68,77,0.02),0px_8px_18px_0px_rgba(56,68,77,0.03)]">
					{/* Search Input - Height: 54px, padding: 29px from Figma */}
					<div class="bg-neutral-50 border border-neutral-200 rounded-2xl px-[29px] h-[54px] flex items-center gap-[8px] mb-[24px]">
						<input
							id="search-input"
							type="text"
						...
						<img src={SEARCH_ICON} alt="Search" class="w-6 h-6" />
						<div class="flex items-center gap-[2px]">
							...
							<span class="text-[16px] leading-[24px] text-neutral-500">
								+K
							</span>
						</div>
					</div>
