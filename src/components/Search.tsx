...
export function SearchButton(): string {
  return (
    <button
      type="button"
      class="hidden lg:flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm text-gray-500 hover:border-gray-300 hover:text-gray-700 transition-colors"
    ...
    >
      ...
      <span>Search...</span>
      <kbd class="hidden sm:inline-flex items-center gap-1 rounded border border-gray-200 bg-gray-50 px-1.5 font-mono text-xs text-gray-400">
...
export function MobileSearchButton(): string {
  return (
    <button
      type="button"
      class="lg:hidden -m-2 p-2 text-gray-500 hover:text-gray-700"
      data-on:click="$searchOpen = true"
    >
...
export function SearchModal(): string {
  return (
    ...
    >
      ...
      {/* Modal */}
      <div class="relative mx-auto max-w-xl transform rounded-xl bg-white shadow-2xl ring-1 ring-black/5 transition-all">
        {/* Search input */}
        <div class="flex items-center border-b border-gray-100 px-4">
          ...
          <input
            type="text"
            name="q"
            class="w-full border-0 bg-transparent px-4 py-4 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
          ...
          />
          <kbd class="hidden sm:inline-flex items-center rounded border border-gray-200 bg-gray-50 px-1.5 font-mono text-xs text-gray-400">
            Esc
          </kbd>
        </div>
        ...
        <div
          ...
          class="px-4 py-3"
        >
          <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Quick links</p>
          <ul class="space-y-1">
            <li>
              <a href="/blog" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100" data-on:click="$searchOpen = false">
                <svg class="size-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a href="/aidbox" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100" data-on:click="$searchOpen = false">
                <svg class="size-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a href="/docs" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100" data-on:click="$searchOpen = false">
                <svg class="size-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a href="/contacts" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100" data-on:click="$searchOpen = false">
                <svg class="size-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
