  ...
  return (
    <section class="bg-white py-16 sm:py-24">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        {CardGrid({
          cols: 3,
          children: leadership.map(person =>
            Card({
              padding: "lg",
              shadow: "sm",
              children: `
                <div class="text-center">
                  ...
                  />
                  <a href="${person.linkedin}" target="_blank" rel="noopener noreferrer" class="mt-4 inline-flex items-center justify-center gap-2 text-xl font-bold text-gray-900 uppercase tracking-wide hover:text-[#0A66C2] transition-colors">
                    ${person.name}
                  ...
                  <p class="mt-1 text-primary font-medium">${person.role}</p>
                  <p class="mt-3 text-gray-600 text-sm leading-relaxed">${person.bio}</p>
                </div>
              `,
            })
          ).join(''),
