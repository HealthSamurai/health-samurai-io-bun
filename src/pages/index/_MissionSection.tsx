    ...
    <Component name="pages/index/MissionSection" className="home-payers-section">
      <div className="home-container-1100">
        <p className="home-offer-desc">
          ...
          <a href="/fhir-server">FHIR server </a> to EHR and EMR systems,
          ...
          data handling capabilities. <br />‍ <br />
          ...
          these resources, we believe amazing things will happen. <br />‍
          <br />
          That's how we believe we can change healthcare for good, and we're
          committed to making our vision a reality daily. Our
          <a href="/fhir-server">FHIR server </a> supports diverse healthcare
