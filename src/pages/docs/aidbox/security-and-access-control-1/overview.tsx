...
// Source: /Users/niquola/health-samurai/webflow/snapshots/docs/aidbox/security-and-access-control-1/overview.html
                    ...
                    <div className="relative inline-flex ml-auto overflow-visible">
                      ...
                      <div className="inline-flex rounded-md shadow-sm">
                        ...
                        <button
                          ...
                          data-md-url="/docs/aidbox/access-control/access-control.md"
                          id="copy-page-button"
                      ...
                      >
                        ...
                        <div className="py-1">
                          ...
                          <a
                            ...
                            href="/docs/aidbox/access-control/access-control.md"
                          ...
                          <a
                            className="w-full flex items-start gap-3 px-4 py-2 text-sm text-on-surface-strong hover:bg-surface-hover transition-colors no-underline"
                            href="https://github.com/healthsamurai/documentation/edit/master/docs-new/../docs/access-control/access-control.md"
                    ...
                    <div>
                      ...
                      <header className="mb-6" id="page-header">
                        ...
                        <p className="text-lg leading-7 font-normal text-on-surface-secondary border-b border-outline-subtle pb-[17px]">
                          Comprehensive access control for healthcare
                          applications with identity management, authentication,
                          authorization, and audit logging. 
                        </p> 
                      </header> 
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        Aidbox offers everything you need for secure identity,
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          ...
                          - Use Aidbox’s built-in provider or plug in Google,
                          Okta, or any OIDC-compliant service 
                        </li> 
                        <li>
                          ...
                          - Supports Basic, OAuth 2.0 &amp; OpenID Connect
                          flows, <br />
                          JWT-based auth and Single Sign-On through external
                          OAuth 2.0 providers. 
                        </li> 
                        <li>
                          ...
                          - Control access with Access Policies, SMART scopes
                          Access Control frameworks, <br />
                          Security Labels framework and Scoped APIs (Patient
                          API, Organization API, Compartments API). 
                        </li> 
                        <li>
                          ...
                          - Track activity with FHIR BALP (Basic Audit Logging
                          Profile) for Audit Events <br />
