...
// Source: /Users/niquola/health-samurai/webflow/snapshots/docs/aidbox/getting-started/run-aidbox-in-sandbox.html

import { Fragment } from "../lib/jsx-runtime";

export const metadata = {
  title: "Run Aidbox in Sandbox | Aidbox Docs",
  description:
    "Get started with Aidbox Cloud Sandbox - create a free hosted FHIR server instance with development license.",
};

export default function RunAidboxInSandboxWebflow(): string {
  return (
    <Fragment>
      <noscript>
        &lt;iframe height="0"
            ...
            <div className="flex items-start">
              ...
              <article className="article__content py-8 min-w-0 flex-1 max-w-5xl transform-3d">
                  ...
                  <div className="flex items-center gap-2 mb-[11px] overflow-visible">
                    ...
                    <nav aria-label="Breadcrumb" className="flex-1">
                      ...
                      <ol className="flex flex-nowrap items-center overflow-hidden">
                        ...
                        <li
                          className="flex items-center gap-2 bg-breadcrumb-bg rounded-md px-2 py-0.5 max-w-48"
                          key="0"
                        >
                           
                          <a
                            className="text-sm font-normal leading-6 text-on-surface hover:text-on-surface-strong truncate"
                            href="/docs/aidbox/getting-started"
                            hxGet="/docs/partial/aidbox/getting-started"
                            hxPushUrl="/docs/aidbox/getting-started"
                            hxSwap="outerHTML"
                    ...
                    <div className="relative inline-flex ml-auto overflow-visible">
                      ...
                      <div className="inline-flex rounded-md shadow-sm">
                        ...
                        <button
                          ...
                          data-md-url="/docs/aidbox/getting-started/run-aidbox-in-sandbox.md"
                          id="copy-page-button"
                      ...
                      >
                        ...
                        <div className="py-1">
                          ...
                          <a
                            ...
                            href="/docs/aidbox/getting-started/run-aidbox-in-sandbox.md"
                          ...
                          <a
                            className="w-full flex items-start gap-3 px-4 py-2 text-sm text-on-surface-strong hover:bg-surface-hover transition-colors no-underline"
                            href="https://github.com/healthsamurai/documentation/edit/master/docs-new/../docs/getting-started/run-aidbox-in-sandbox.md"
                ...
                <div className="mx-auto max-w-full">
                  ...
                  <div className="real-content flex-1 min-w-0 max-w-full">
                    ...
                    <div>
                      ...
                      <header className="mb-6" id="page-header">
                        ...
                        <div>
                          ...
                          <h1
                            ...
                            id="run-aidbox-in-sandbox"
                          >
                            Run Aidbox in Sandbox 
                          </h1> 
                        </div> 
                        <p className="text-lg leading-7 font-normal text-on-surface-secondary border-b border-outline-subtle pb-[17px]">
                          Get started with Aidbox Cloud Sandbox - create a free
                          hosted FHIR server instance with development
                          license. 
                        </p> 
                      </header> 
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        This quickstart guide explains how to run 
                        <strong>Aidbox </strong> in the 
                        <a
                          className="text-brand underline underline-offset-2 decoration-[max(0.07em,1px)] hover:text-on-surface-strong hover:decoration-brand transition-all duration-200 inline-flex items-center gap-1"
                          href="https://aidbox.app"
                        >
                          Aidbox Cloud Sandbox 
                          <svg
                        ...
                        . It will help you set up a hosted Aidbox instance with
                        a <strong>Development license </strong> You will learn
                        to get a hosted Aidbox instance with a Development
                        license. 
                      </p> 
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="sign-up-for-the-aidbox-portal"
                      ...
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="create-a-managed-aidbox-instance"
                        style="position: relative;"
                      >
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          Click the <strong>New License </strong> button in the
                          portal. 
                        </li> 
                        <li>
                          ...
                          <ul className="text-base text-on-surface-secondary space-y-2">
                            ...
                            <li>
                              ...
                              <strong>License Type </strong>: Development
                              license (free, no PHI, with a 5 GB database
                              limit). 
                            </li> 
                            <li>
                               
                              <strong>License Name </strong>: Add a descriptive
                              name for your license and specify your goal. 
                            </li> 
                            <li>
                               
                              <strong>Hosting Option </strong>: Google Cloud
                              Platform. 
                            </li> 
                            <li>
                               
                              <strong>Aidbox Version </strong>: Choose “Edge” or
                              “Latest.” 
                            </li> 
                            <li>
                               
                              <strong>Instance URL </strong>: Provide the
                              desired URL for your Aidbox instance. 
                            </li> 
                            <li>
                               
                              <strong>FHIR Version </strong>: Select the
                      ...
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="access-your-aidbox-instance"
                        style="position: relative;"
                      >
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          You can open your 
                          <strong>hosted Aidbox instance </strong> in a browser
                          by clicking the <strong>Instance URL </strong> link on
                ...
                <p className="mt-4 text-sm text-on-surface-muted">
                  Last updated: 
                  <time
                    data-updated-at="2025-12-05T13:53:00Z"
                    datetime="2025-12-05T13:53:00Z"
                    id="lastupdated"
                  >
                    1 month ago 
                  </time> 
                ...
                <ul className="space-y-0.5">
                  ...
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      ...
                      href="#sign-up-for-the-aidbox-portal"
                      data-toc-handler="true"
                    >
                       
                      <span>Sign up for the Aidbox portal </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface-placeholder"
                      href="#create-a-managed-aidbox-instance"
                      data-toc-handler="true"
                    >
                       
                      <span>Create a managed Aidbox instance </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface-placeholder"
                      href="#access-your-aidbox-instance"
                      data-toc-handler="true"
                    >
                       
                      <span>Access your Aidbox instance </span> 
                    </a> 
                  </li> 
                </ul> 
              </nav> 
