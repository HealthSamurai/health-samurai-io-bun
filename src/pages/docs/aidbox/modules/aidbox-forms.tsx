...
// Source: /Users/niquola/health-samurai/webflow/snapshots/docs/aidbox/modules/aidbox-forms.html

import { Fragment } from "../lib/jsx-runtime";

export const metadata = {
  title: "Aidbox Forms | Aidbox Docs",
  description: "Form building and structured data capturing with Aidbox",
};

export default function AidboxFormsWebflow(): string {
  return (
    <Fragment>
      <noscript>
        &lt;iframe height="0"
            ...
            <div className="flex items-start">
              ...
              <article className="article__content py-8 min-w-0 flex-1 max-w-5xl transform-3d">
                    ...
                    <div className="relative inline-flex ml-auto overflow-visible">
                      ...
                      <div className="inline-flex rounded-md shadow-sm">
                        ...
                        <button
                          ...
                          data-md-url="/docs/aidbox/modules/aidbox-forms.md"
                          id="copy-page-button"
                      ...
                      >
                        ...
                        <div className="py-1">
                          ...
                          <a
                            ...
                            href="/docs/aidbox/modules/aidbox-forms.md"
                          ...
                          <a
                            className="w-full flex items-start gap-3 px-4 py-2 text-sm text-on-surface-strong hover:bg-surface-hover transition-colors no-underline"
                            href="https://github.com/healthsamurai/documentation/edit/master/docs-new/../docs/modules/aidbox-forms/README.md"
                    ...
                    <div>
                      ...
                      <header className="mb-6" id="page-header">
                        ...
                        <p className="text-lg leading-7 font-normal text-on-surface-secondary border-b border-outline-subtle pb-[17px]">
                          Form building and structured data capturing with
                          Aidbox 
                        </p> 
                      </header> 
                      <div className="my-4 rounded-lg p-4 bg-info-2 text-info-12">
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="hint flex-1">
                             
                            <p className="text-base text-on-surface-secondary leading-relaxed">
                              Aidbox Forms is a 
                              <strong>pluggable module </strong> for healthcare
                              vendors who need 
                              <strong>to create digital forms </strong>,
                              questionnaires, and surveys for clinical
                              workflows. 
                            </p> 
                          </div> 
                        </div> 
                      ...
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        It allows to design and embed digital medical forms and
                        capture data in FHIR format for reporting and
                        analysis. 
                      </p> 
                      <div className="my-4 rounded-lg p-4 bg-info-2 text-info-12">
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="hint flex-1">
                            ...
                            <p className="text-base text-on-surface-secondary leading-relaxed">
                              To play with forms on a test data without
                              authorization and without creating an Aidbox
                              instance, use the 
                              <a
                              ...
                              . In it, you can create a form, download its
                              definition, or share it via a link. 
                            </p> 
                          </div> 
                        </div> 
                      </div> 
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          Ready-made medical form repository ( 
                          <a
                        ...
                        <li>
                          ...
                          for creating forms without a code (based on 
                          <a
                            className="text-brand underline underline-offset-2 decoration-[max(0.07em,1px)] hover:text-on-surface-strong hover:decoration-brand transition-all duration-200 inline-flex items-center gap-1"
                            href="https://build.fhir.org/ig/HL7/sdc/index.html"
                          >
                      ...
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="by-using-aidbox-forms-you-can"
                        style="position: relative;"
                      >
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          Create a form with complex logic from scratch in UI
                          Builder 
                        </li> 
                        <li>
                          Create a form by importing FHIR Questionnaire from
                          external sources 
                        </li> 
                        <li>
                          Use a ready-made form from Aidbox Form Gallery or
                          customise it according to your requirements 
                        </li> 
                        <li>Test form in UI Builder </li> 
                        <li>Pre-fill form with existing data </li> 
                        <li>Add any validation rules to the forms </li> 
                        <li>Extract data and store them in FHIR resources </li> 
                        <li>
                          Binding of forms in the workflow with complex logic
                          and data prefilling 
                        </li> 
                        <li>
                          Coding clinical data with LOINC, SNOMED, RxNorm and
                          others 
                        </li> 
                        <li>
                          Integrate form into your current solutions with the
                          versatile API, iframe, and generate a link 
                        </li> 
                        <li>Capture and store data in FHIR storage </li> 
                      </ul> 
                    </div> 
                  </div> 
                </div> 
                ...
                <p className="mt-4 text-sm text-on-surface-muted">
                  Last updated: 
                  <time
                    data-updated-at="2025-05-13T12:31:10Z"
                    datetime="2025-05-13T12:31:10Z"
                    id="lastupdated"
                  >
                    8 months ago 
                  </time> 
                ...
                <ul className="space-y-0.5">
                  ...
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      ...
                      href="#aidbox-forms-provides"
                      data-toc-handler="true"
                    >
                       
                      <span>Aidbox Forms provides: </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface-placeholder"
                      href="#by-using-aidbox-forms-you-can"
                      data-toc-handler="true"
                    >
                       
                      <span>By using Aidbox Forms you can: </span> 
                    </a> 
                  </li> 
                </ul> 
              </nav> 
