...
// Source: /Users/niquola/health-samurai/webflow/snapshots/docs/aidbox/modules/other-modules/mpi.html
...
export default function MpiWebflow(): string {
  return (
    <Fragment>
      <noscript>
        &lt;iframe height="0"
        ...
        <div className="flex-1 flex max-w-screen-2xl mx-auto site-full-width:max-w-full items-start overflow-visible md:px-8">
          ...
          >
            ...
            <div className="break-words mt-4 border-t border-outline-subtle pt-4 first:mt-0 first:border-t-0 first:pt-0">
              ...
              <div className="nav-item open active text-primary-9 bg-tint-2 border-primary-9">
                ...
                <div className="nav-children ml-6 border-l-1 border-outline">
            ...
            <div className="flex items-start">
              ...
              <article className="article__content py-8 min-w-0 flex-1 max-w-5xl transform-3d">
                    ...
                    <div className="relative inline-flex ml-auto overflow-visible">
                      ...
                      <div className="inline-flex rounded-md shadow-sm">
                        ...
                        <button
                          ...
                          data-md-url="/docs/aidbox/modules/mpi.md"
                          id="copy-page-button"
                      ...
                      >
                        ...
                        <div className="py-1">
                          ...
                          <a
                            ...
                            href="/docs/aidbox/modules/mpi.md"
                          ...
                          <a
                            className="w-full flex items-start gap-3 px-4 py-2 text-sm text-on-surface-strong hover:bg-surface-hover transition-colors no-underline"
                            href="https://github.com/healthsamurai/documentation/edit/master/docs-new/../docs/modules/mpi/README.md"
                ...
                <div className="mx-auto max-w-full">
                  ...
                  <div className="real-content flex-1 min-w-0 max-w-full">
                    ...
                    <div>
                      ...
                      <header className="mb-6" id="page-header">
                        ...
                        <div>
                          ...
                          <h1
                            ...
                            id="mpi-master-patient-index"
                          >
                            MPI — Master Patient Index 
                          </h1> 
                        </div> 
                        <p className="text-lg leading-7 font-normal text-on-surface-secondary border-b border-outline-subtle pb-[17px]">
                          This page introduces the Aidbox MPI module, its core
                          capabilities, and guides for deployment,
                          configuration, matching, and merge/unmerge
                          operations. 
                        </p> 
                      </header> 
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                         
                        <strong>Master Patient Index (MPI) </strong> is a module
                        in Aidbox that ensures 
                        <strong>accurate patient identification </strong> by
                        detecting and removing duplicate records. It helps
                        maintain consistent and reliable data across healthcare
                        systems. 
                      </p> 
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          ...
                          of patient records across different systems and
                          facilities, 
                        </li> 
                        <li>
                          ...
                          <a
                            className="text-brand underline underline-offset-2 decoration-[max(0.07em,1px)] hover:text-on-surface-strong hover:decoration-brand transition-all duration-200"
                            href="/docs/aidbox/modules/mpi/merging-and-unmerging-records-usdmerge-and-usdunmerge#merge-operation"
                          >
                            merging 
                          </a> 
                          of duplicate records into a single record, 
                        </li> 
                        <li>
                           
                          <a
                            className="text-brand underline underline-offset-2 decoration-[max(0.07em,1px)] hover:text-on-surface-strong hover:decoration-brand transition-all duration-200"
                            href="/docs/aidbox/modules/mpi/merging-and-unmerging-records-usdmerge-and-usdunmerge#unmerge-operation"
                          >
                            unmerging 
                          </a> 
                          of incorrectly linked records, 
                        </li> 
                        <li>
                          maintaining the <strong>integrity </strong> of
                          clinical data and treatment history. 
                        </li> 
                      </ul> 
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        Using MPI <strong>reduces the risk </strong> of lost or
                        duplicated medical data, treatment errors, and issues
                        with data exchange. This is especially critical in
                        complex ecosystems with many sources — such as clinics,
                        labs, and telemedicine platforms. 
                      </p> 
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        The MPI module utilizes <strong>probabilistic </strong> 
                        (score-based or Fellegi-Sunter) method. It is more
                        flexible and can provide better results than rule-based
                        approaches, but at the cost of simplicity. 
                      </p> 
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="mpi-capabilities-overview"
                      ...
                      <h3
                        className="mt-8 text-2xl font-semibold text-on-surface-strong mx-auto"
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          API-first architecture with a user-friendly web-based
                          UI 
                        </li> 
                        <li>
                          Notifications for external systems via webhooks
                          (non-FHIR format) 
                        </li> 
                        <li>
                          Unlimited scalability — supports any number of patient
                          records 
                        </li> 
                        <li>
                      ...
                      <h3
                        className="mt-8 text-2xl font-semibold text-on-surface-strong mx-auto"
                        id="data-safety-transparency-and-consistency"
                        style="position: relative;"
                      >
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          Full traceability of all operations, user actions and
                          API calls 
                        </li> 
                        <li>
                          Supports complience with security and regulatory
                          standarts 
                        </li> 
                      </ul> 
                      <h3
                      ...
                      <ul className="text-base text-on-surface-secondary space-y-2">
                        ...
                        <li>
                          Flexible patient matching using a probabilistic
                          algorithm 
                          <ul className="text-base text-on-surface-secondary space-y-2">
                             
                            <li>
                              Fully configurable for specific data and
                              use-cases 
                            </li> 
                        ...
                        <li>
                          Manual record merging with unique merge strategy
                          combining golden record and survivor record
                          approaches 
                        </li> 
                        <li>Unmerge capability </li> 
                        <li>
                          Ability to mark record pairs as non-duplicates to
                          exclude them from future match results 
                        </li> 
                      </ul> 
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="run-mpi-with-kubernetes"
                        style="position: relative;"
                      >
                      ...
                      <p className="text-base text-on-surface-secondary leading-relaxed"></p> 
                      <div className="big-link mt-2 mb-4 p-4 border border-outline rounded-lg bg-surface hover:border-outline-input-focus transition-all duration-200 flex items-center cursor-pointer group">
                         
                        <div className="flex-1">
                           
                          <a
                            className="text-base font-sans font-normal text-on-surface-strong transition-colors duration-200 no-underline block w-full h-full"
                            href="/docs/aidbox/modules/mpi/get-started/run-mdm-locally"
                          >
                            Run MDM locally 
                          </a> 
                        ...
                        <svg
                          className="chevron size-5 text-on-surface-strong/40"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          aria-hidden="true"
                      ...
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        Configure Aidbox MPI module to use your matching
                        model 
                      </p> 
                      <p className="text-base text-on-surface-secondary leading-relaxed"></p> 
                      <div className="big-link mt-2 mb-4 p-4 border border-outline rounded-lg bg-surface hover:border-outline-input-focus transition-all duration-200 flex items-center cursor-pointer group">
                      ...
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        Use <code>&#36;match </code> operation to find
                        duplicates 
                      </p> 
                      <h2
                        className="mt-[1.05em] text-4xl font-semibold text-on-surface-strong mx-auto"
                        id="merge-and-unmerge-records"
                        style="position: relative;"
                      >
                      ...
                      <p className="text-base text-on-surface-secondary leading-relaxed">
                        Use <code>&#36;merge </code> and 
                        <code>&#36;unmerge </code> operations to manage
                      ...
                      <ol className="mt-2 min-w-0 w-full decoration-primary/6 page-full-width:ml-0 max-w-3xl page-api-block:ml-0 space-y-2 text-on-surface-secondary">
                         
                        <li className="leading-normal flex items-start">
                           
                          <div className="text-base leading-normal mr-1 flex min-h-[1lh] min-w-6 items-center justify-center text-on-surface-secondary">
                             
                            <div>1. </div> 
                          </div> 
                          <div className="flex min-w-0 flex-1 flex-col">
                             
                            <div className="w-full decoration-primary/6 page-full-width:ml-0 max-w-3xl min-h-[1lh] flip-heading-hash [&:is(h2)>div]:mt-0 [&:is(h3)>div]:mt-0 [&:is(h4)>div]:mt-0 mx-0">
                      ...
                      <p></p> 
                      <ol
                        className="mt-2 min-w-0 w-full decoration-primary/6 page-full-width:ml-0 max-w-3xl page-api-block:ml-0 space-y-2 text-on-surface-secondary"
                        start="2"
                      >
                ...
                <p className="mt-4 text-sm text-on-surface-muted">
                  Last updated: 
                  <time
                    data-updated-at="2025-11-18T09:07:04Z"
                    datetime="2025-11-18T09:07:04Z"
                    id="lastupdated"
                  >
                    2 months ago 
                  </time> 
                ...
                <ul className="space-y-0.5">
                  ...
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      ...
                      href="#mpi-capabilities-overview"
                      data-toc-handler="true"
                    >
                       
                      <span>MPI Capabilities Overview </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words ml-2 border-l-1 border-outline-subtle my-0">
                     
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface"
                  ...
                  <li className="max-w-56 break-words ml-2 border-l-1 border-outline-subtle my-0">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface"
                      href="#data-safety-transparency-and-consistency"
                      data-toc-handler="true"
                    >
                  ...
                  <li className="max-w-56 break-words ml-2 border-l-1 border-outline-subtle my-0">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface"
                      href="#core-feature-set"
                      data-toc-handler="true"
                    >
                       
                      <span>Core Feature set </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface-placeholder"
                      href="#run-mpi-with-kubernetes"
                      data-toc-handler="true"
                    >
                       
                      <span>Run MPI with Kubernetes </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface-placeholder"
                      href="#configure-mpi-module"
                      data-toc-handler="true"
                    >
                       
                      <span>Configure MPI module </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
                  ...
                  <li className="max-w-56 break-words py-0.5">
                    ...
                    <a
                      className="block px-3 text-sm leading-5 font-normal no-underline relative py-1 transition-colors duration-[300ms] ease-out hover:bg-surface-nav-hover text-on-surface-placeholder"
                      href="#merge-and-unmerge-records"
                      data-toc-handler="true"
                    >
                       
                      <span>Merge and Unmerge Records </span> 
                    </a> 
                  </li> 
                  <li className="max-w-56 break-words py-0.5">
