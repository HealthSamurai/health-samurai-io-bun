              ...
              <div class="flex-1 min-w-0 max-w-[784px]">
                ...
                <div class="mb-8 p-6 bg-[#f8f9fa] rounded-xl">
                  ...
                  <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    >
                      <svg class="w-5 h-5 text-[#717684]" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a
                      ...
                      class="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-[#e9ecef] text-[#353b50] hover:border-[#717684] rounded-lg transition-colors"
                    >
                      <svg class="w-5 h-5 text-[#20808d]" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 0L1.5 6v12L12 24l10.5-6V6L12 0zm0 2.18l8.25 4.72v9.2L12 20.82l-8.25-4.72v-9.2L12 2.18zM12 6a6 6 0 100 12 6 6 0 000-12zm0 2a4 4 0 110 8 4 4 0 010-8z" />
                      </svg>
                    ...
                    <a
                      ...
                      class="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-[#e9ecef] text-[#353b50] hover:border-[#717684] rounded-lg transition-colors"
                    >
                      <svg class="w-5 h-5 text-[#d97706]" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a
                      ...
                      class="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-[#e9ecef] text-[#353b50] hover:border-[#717684] rounded-lg transition-colors"
                    >
                      <svg class="w-5 h-5 text-[#353b50]" viewBox="0 0 24 24" fill="currentColor">
