...
export const products: Product[] = [
  ...
  },
  {
    ...
    label: "Smartbox",
    href: "/smartbox",
    description: "SMART on FHIR application launcher and testing",
  ...
  },
  {
    ...
    label: "Auditbox",
    href: "/auditbox",
    description: "FHIR-native audit record repository for compliance",
  ...
  },
  {
    ...
    label: "Edibox",
    href: "/edibox",
    description: "Healthcare EDI transaction processing (X12, HL7)",
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="size-6 text-gray-600 group-hover:text-primary"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5"/></svg>`,
  },
];
