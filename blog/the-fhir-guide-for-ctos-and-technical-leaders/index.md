---
{
  ...
  "description": "Our CTO provides a brief technical overview of the HL7 FHIR Standard, from analysis of HL7 FHIR healthcare informational data model to potential use cases using FHIR APIs and potential limitations you should be aware of when planning to develop using FHIR standard.",
