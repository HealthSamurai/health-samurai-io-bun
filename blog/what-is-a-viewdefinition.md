---
{
  "url": "https://www.health-samurai.io/articles/what-is-a-viewdefinition",
...
This view produces a table of patient contacts, with each row representing a telecom entry.
  ...
  Highlighted Text
    ...
    - "where" filters only active patients

    - "forEach" unnests Patient.telecom and selects phone numbers

    - "forEach" unnests Patient.contact.telecom and selects phone numbers

    - "unionAll" concatenates the results of the two "forEach" operations

    - "column" statement extracts id and ssn

    - "select" statement cross-joins id and ssn with telecom phone numbers
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66a351418fb364317094242a_66a14a085b97f652d8d3f013_2024-07-24%252017.51.06.jpeg)
There is an official list of implementations available at [https://fhir.github.io/sql-on-fhir-v2/#impls](https://fhir.github.io/sql-on-fhir-v2/#impls). Most implementations are in-memory engines. Aidbox (PostgreSQL) and Pathling (Spark SQL) are in-database engines.
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66a79f0649b1b49286433ea9_66a79dc44de2d86d259ba2c7_view.png)
