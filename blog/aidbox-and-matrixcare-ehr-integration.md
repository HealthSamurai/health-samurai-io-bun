...
![MatrixCare & Aidbox Integration pipeline](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e23446396c84e68ca6d_62d54032869dc458dba2c8f4_A1.png)
...
![MatrixCare HL7v2 Feed](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e23446396c84e68ca4e_62d53f9649ba538ce1ee38c1_A2.png)
...
![HL7v2 Message Example](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e22446396c84e68ca28_62d540590e07ab8ab5eb0e73_A3.png)
...
- there is comprehensive documentation for each segment, e.g: [https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MSH](https://hl7-definition.caristix.com/v2/HL7v2.5.1/Segments/MSH)
...
![MatrixCare & Amazon SQS Integration](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e23446396c84e68ca54_62d5408c34f1825eabb1ec92_A4.png)
...
![Amazon SQS & DLQ & Aidbox Integration](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e22446396c84e68ca2b_62d540a37fb32a1547dc6a4d_A5.png)
...
- Persist incoming messages in the database (Aidbox DB [https://docs.aidbox.app/storage-1/database](https://docs.aidbox.app/storage-1/database)) to avoid data loss or data malformity;
- Parse message to human and machine-readable data structures (HL7v2 parser [https://docs.aidbox.app/modules-1/hl7-v2-integration](https://docs.aidbox.app/modules-1/hl7-v2-integration)); 
- Parse message to FHIR data using JUTE mapping language (data-DSL by Health Samurai [https://github.com/HealthSamurai/jute.clj](https://github.com/HealthSamurai/jute.clj));
...
![HL7v2 to Aidbox](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e23446396c84e68cacf_62d540d9cb5c404d17ad8772_A6.png)
...
![HL7v2 statuses within Aidbox](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e22446396c84e68ca41_62d540f51b69722dc30a515d_A7.png)

- the **config **field should also be supported – **config** defines which set of **mappings** (you can read about them at [https://docs.aidbox.app/tools/mappings](https://docs.aidbox.app/tools/mappings)) will be applied. **Config** is stored in the HL7v2Config resource, mappings are stored as a Mapping resource;  
...
![FHIR mapping](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e22446396c84e68ca3e_62d5412dbea24abd54d2e9a6_A8.png)
...
- they provide a mechanism for **persisting** data (some state that FHIR was created for interchanging data and not for persisting data, but we have an opposing view:  [https://www.health-samurai.io/articles/should-you-use-fhir-resources-as-your-data-storage-format](https://www.health-samurai.io/articles/should-you-use-fhir-resources-as-your-data-storage-format));
- the set of mappings applied to the parsed field is configured via the HL7v2Config resource, which you may read more about here: [https://docs.aidbox.app/modules-1/hl7-v2-integration](https://docs.aidbox.app/modules-1/hl7-v2-integration).
...
Link: [https://github.com/HealthSamurai/jute.clj](https://github.com/HealthSamurai/jute.clj)



You might ask how mapping applications result in **persisting** data. We will try to explain this to you:
![Aidbox Mapping Resource example / JUTE](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64e23446396c84e68ca51_62d542a40aa2d661296d61f3_A9.png)
...
[![Aidbox FHIR Platform Free Trial](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66aa4e7546a8f22a85bc95f0_6372827a1dc615dd429dbed4_1200x628%2520-%2520reliable(1).png)](https://www.health-samurai.io/aidbox)
