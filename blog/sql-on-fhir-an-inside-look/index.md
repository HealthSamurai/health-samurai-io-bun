---
{
  ...
  "image": "https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2aef_64d61d309da29c9182f02e47_3156679(4).png",
  "date": "2024-05-08",
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b0d_64d62c1d813a4f01ad3b40a9_Code%2520block(9).png)Let's look at how to "translate" complex FHIR data into a table-like format. For that, we need to create a flattened View Definition for a Patient resource. In our case, the view will contain patient id, birthdate, gender, race and name parameters.
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b20_64d62c50fbb1b930c5fddbf2_Code%2520block(11).png)As a result, we will create the following flat table:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2ae3_64d6294d6970ec176e5b0ec5_Table(6)_cropped%25201.png)Let's take one more FHIR resource – Condition:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b15_64d62c3231b1661c9fc37f2f_Code%2520block(10).png)Let’s flatten the Condition resource just the way we did with the Patient resource. The view will contain id, patient id, code, status, verification status and recorded date parameters:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b12_64d62c67a0b4c9b5dbc53646_Code%2520block(12).png)As a result, we will get the following flat table:
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2ada_64d62c7331085d23a21c562c_Code%2520block(13).png)As a result, we will get the following flat table:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2ae6_64d62a7d3b1eec199e545286_Table(8)_cropped%25201.png)Now we're going to use both Patient and Condition views to get even more insights. Let’s count how many men and women have a prediabetes condition:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b19_64d62c873b43b2c87c819855_Code%2520block(14).png)Here's what we get:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b07_64d60a2a3585f6bbbaef4708_Table(3).png)Now let’s find out the condition duration:

![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2af4_64d62caa0ccc37b64e35ce7d_Code%2520block(15).png)The resulting flat table looks as follows:

![SQL Flat table with condition duration](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2afe_64d62ac63b1eec199e54a62f_Table(9)_cropped%25201.png)Now let’s find the average prediabetes duration for men and women:

![JSON to count average prediabetes duration](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66ab9c4d3539ed9160be2b04_64d62cb7b29bb31b82f9c914_Code%2520block(16).png)As a result, we find out the average condition duration for each gender:
