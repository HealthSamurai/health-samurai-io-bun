---
{
  "url": "https://www.health-samurai.io/articles/implementing-unique-constraints",
...
- **CREATE UNIQUE INDEX patient_ssn_unique_idx1**This defines a unique index named \`patient_ssn_unique_idx1\`. When you create a **unique index**, PostgreSQL prevents duplicate values in the specified column(s). If a duplicate value is inserted, the database will throw a **unique constraint violation** error.
