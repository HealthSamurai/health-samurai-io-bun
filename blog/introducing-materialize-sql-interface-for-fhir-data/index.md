---
{
  ...
  "description": "The new $materialize operation in Aidbox creates SQL tables or views from FHIR ViewDefinition resources, making nested FHIR data easier to query.\nIt helps turn complex JSON structures into familiar tabular formats for use with standard SQL tools.",
  "image": "",
  "date": "2025-09-17",
