...
>   - "Durat"  
>   - "ECG"  
>   ....****property****:****loinc****:****relatednames2****: Cardiac; Durat; ECG; EKG.MEASUREMENTS; ...****method_typ****: EKG****classtype****: '2'****system****: Heart****time_aspct****: Pt****common_order_rank****: '0'****property****: Time****order_obs****: Observation****unitsrequired****: Y  
>           ....*
