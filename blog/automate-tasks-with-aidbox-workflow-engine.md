...
- Event-based scheduling via Subscription triggers
- Time-based scheduling via the Scheduler
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64b962264f0704a6d6c65_6492d2db4cb02e4387f602d5_rule-based%2520workflow.jpeg)
...
![](https://cdn.prod.website-files.com/58ecfb695710f07cd0a35e9c/66b64b962264f0704a6d6c5b_6492d338c209dd539bcfbf75_rule-based%2520workflow(2).jpeg)
...
- Select from the built-in tasks or implement your own tasks via the SDK
- Implement workflow processes using the SDK
- Trigger workflow execution by event or time, or run it manually via your API
- Check workflow execution using the Monitoring Console
